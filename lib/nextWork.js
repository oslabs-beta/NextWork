...
const baseFetch = transpiledFetch.default;
const { nanoid } = require('nanoid');
console.log('this is nanoid', nanoid);
const fs = require('node:fs');
const path = require('node:path');
const { URL } = require('node:url');
const { addHeaders, buildRequestCookies, buildHeaders, buildQueryParams, buildParams, buildResponseCookies, getDuration, } = require('./helpers.ts');
